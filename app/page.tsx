...
export default function Home() {
  return (
    <main className="min-h-screen p-8 bg-[#F7F7ED]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* 1080x1080 examples */}
            <div>
              <h3 className="text-lg font-medium mb-2">1080x1080 (kvadratiskt format)</h3>
              <img 
            ...
            {/* 1920x1080 examples */}
            <div>
              <h3 className="text-lg font-medium mb-2">1920x1080 (stående format)</h3>
              <img 
